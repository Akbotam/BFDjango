...
class DishView(ListView):
    model = Dish
    template_name = 'Task/dishes.html'

class ResDetailView(DetailView):
    model = Restaurant
    template_name = 'Task/res_detail.html'

class ResCreateView(CreateView):
	model = Restaurant
	fields = ['name', 'number', 'telephone', 'city']
	template_name = 'Task/res_add_form.html'
...
class ResUpdateView(UpdateView):
	model = Restaurant
	fields = ['name', 'number', 'telephone', 'city']
	template_name = 'Task/res_update_form.html'

class ResDeleteView(DeleteView):
	model = Restaurant
	success_url = reverse_lazy('index')
	template_name = 'Task/res_delete_form.html' 